...
if __name__ == "__main__":
    # Create an instance of the ExportedHand
    hand = Hand()

    # Generate some handwriting
    hand.write(
        filename="exported_sample.svg",
        lines=[f"{i} Aditya Nandan q" for i in range(13)],
        biases=[1.0 for i in range(13)],
        styles=[i for i in range(13)],
    )

    print("Handwriting sample generated!")
